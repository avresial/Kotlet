...
export class PantryService {
  ...
  create(ingredientId: string, quantity: number, expirationDate: string | null) { return this.http.post<PantryItem>(apiUrl('/api/pantry'), { ingredientId, quantity, expirationDate }); }
