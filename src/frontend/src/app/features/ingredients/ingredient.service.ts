...
import { Ingredient, IngredientDetailsSuggestion, IngredientRequest } from './ingredient.models';
...
export class IngredientService {
  ...
  autofill(name: string) { return this.http.post<IngredientDetailsSuggestion>(apiUrl('/api/ingredients/autofill'), { name }); }
