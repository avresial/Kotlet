...
namespace Kotlet.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260810102953_AddPantryReconciliation")]
    partial class AddPantryReconciliation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kotlet.Domain.AgentMemory.AgentMemory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("CreatedByClient")
                        ...
                        .HasColumnName("created_by_client");
                    ...
                    b.Property<string>("UpdatedByClient")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("updated_by_client");
                    ...
                    b.HasIndex("UserId", "HouseId", "IsDeleted")
                        .HasDatabaseName("ix_agent_memories_scope_deleted");

                    b.HasIndex("UserId", "HouseId", "Revision")
                        .HasDatabaseName("ix_agent_memories_scope_revision");

                    b.ToTable("agent_memories", "kotlet");
                });

            modelBuilder.Entity("Kotlet.Domain.AgentMemory.AgentMemoryCollection", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
                    ...
                    b.ToTable("agent_memory_collections", "kotlet");
                });
            ...
            modelBuilder.Entity("Kotlet.Domain.MealPlanner.MealPlanItemParticipant", b =>
                {
                    ...
                    b.Property<int>("PortionPercent")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(100)
                        .HasColumnName("portion_percent");
                    ...
                    b.ToTable("meal_plan_item_participants", "kotlet", t =>
                        {
                            t.HasCheckConstraint("CK_meal_plan_item_participants_portion_percent", "portion_percent BETWEEN 50 AND 150");
                        });
                });
            ...
            modelBuilder.Entity("Kotlet.Domain.PreparedMeals.PreparedMeal", b =>
                {
                    ...
                    b.ToTable("prepared_meals", "kotlet", t =>
                        {
                            t.HasCheckConstraint("ck_prepared_meals_values", "servings > 0 AND (price IS NULL OR price >= 0) AND calories_per_serving >= 0");
                        });
                });
            ...
            modelBuilder.Entity("Kotlet.Domain.Shopping.ShoppingListItem", b =>
                {
                    ...
                    b.HasIndex("HouseId", "PreparedMealId")
                        .IsUnique()
