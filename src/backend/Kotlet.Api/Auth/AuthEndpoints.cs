...
public static class AuthEndpoints
{
    ...
    private static CurrentUserResponse ToResponse(User user) => new(user.Id, user.Email, ResolveDisplayName(user.DisplayName, user.Email), user.PreferredLanguage, user.CreatedAtUtc, user.LastLoginAtUtc);
