...
(see [docs/mcp-apps-recipe-ui.md](docs/mcp-apps-recipe-ui.md)). Codex can install the
same connection as a plugin, together with a recipe-import workflow skill
(see [plugins/kotlet/README.md](plugins/kotlet/README.md)).
